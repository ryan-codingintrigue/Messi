...
(function ($) {
    ...
    var Messi = function (data, options) {
        ...
        if (this.options.buttons.length > 0) {
            ...
            for (var i = 0; i < this.options.buttons.length; i++) {
                ...
                btn.on('click', 'button', (function (self, value) {
                    return function () {
                        var after = (self.options.callback != null) ? function () {
        ...
        // then create one
        this.modal = (this.options.modal && !$(".messi-modal").length) ? $('<div class="messi-modal"></div>').css({
            opacity: this.options.modalOpacity,
            width: $(document).width(),
            height: $(document).height(),
            'z-index': this.options.zIndex + $('.messi').length
    ...
    Messi.prototype = {
        ...
        setContent: function (data) {
            this.findElement(".messi-content").css({
